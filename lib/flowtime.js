...
function generate(context, metadata, dst) {
    ...
    else { console.log("Couldn't find CSS files for Flowtimee at "+cssdir); }
    ...
    else { console.log("Couldn't find JS files for engine Flowtime at "+jsdir); }
    ...
    else { console.log("Couldn't find image files for engine Flowtime at "+imgdir); }
